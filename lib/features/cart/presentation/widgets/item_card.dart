...
class ItemCard extends StatelessWidget {
  ...
  const ItemCard({Key? key, required this.itemCart}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          di.sl<CartBloc>()..add(DeleteItemCartEvent(itemCart: itemCart)),
      child: BlocConsumer<CartBloc, CartState>(
        ...
        builder: (context, state) {
          ...
          return const LoaderIndicator(size: 30, lineWidth: 4);
        },
      ),
    );
  }
